"""Environment-driven settings and structured logging for the API service.
...
This module is intentionally duplicated in the worker service rather than shared
via a package, to keep each image's build context independent (see the note at
the top of IMPLEMENTATION_PLAN.md). Keep the two copies in sync.
"""
